          ...
          <header className="header">
            <div className="header__hero">
              ...
              <p> <ol type = "1" className="list-writeup">
                <li>First step: To respect and honor each other</li>
                <li>Second step: To share each other’s joy and sorrow</li>
                <li>Third step: To trust and be loyal to each other</li>
                <li>Fourth step: To cultivate appreciation for knowledge, values, sacrifice and service</li>
                <li>Fifth step: To appreciate purity of emotions, love, family duties and spiritual growth</li>
                <li>Sixth step: To follow principles of Dharma</li>
                <li>Seventh step: To nurture an eternal bond of friendship and love</li>
