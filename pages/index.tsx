              ...
              <div className="project-card__right">
                ...
                <div className="project-card__socials">
                  <a
                    ...
                    href="/sangeet"
                  >
                    <img src="svg/icon-dhol.svg" alt="sangeet" />
                  </a>
                  <a
                    rel="noopener"
                    target="_blank"
                    href="/sangeet"
                  >
                    <img src="svg/icon-microphone.svg" alt="sangeet" />
                  </a>
                  <a
                    rel="noopener"
                    target="_blank"
                    href="/sangeet"
                  >
                    <img src="svg/icon-dancing.svg" alt="sangeet" />
                  </a>
                </div>
              </div>
            </div>
              ...
              <div className="project-card__right">
                ...
                <div className="project-card__socials">
                  <a
                    ...
                    href="/haldi"
                  >
                    <img src="svg/icon-haldi.svg" alt="mangalasnanam" />
                  </a><a
                    rel="noopener"
                    target="_blank"
                    href="/haldi"
                  >
                    <img src="svg/icon-flower.svg" alt="mangalasnanam" />
                  </a>
                  <a
                    rel="noopener"
                    target="_blank"
                    href="/haldi"
                  >
                    <img src="svg/icon-mangalasnan.svg" alt="mangalasnanam" />
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="project-card">
              ...
              <div className="project-card__right">
                ...
                <a
                    ...
                    href="/varmala"
                  >
                    <img src="svg/icon-varmala.svg" alt="varmala" />
                  </a>
                  <a
                    rel="noopener"
                    target="_blank"
                    href="/varmala"
                  >
                    <img src="svg/icon-swing.svg" alt="varmala" />
                  </a>
